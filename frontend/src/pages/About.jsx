function About() {
    return (
        <div className="about">
            ...
            <p className="about-p">
                After completing the test, you will be able to see your wpm, original wpm, accuracy  and testing information. You can also see a graph of your wpm and raw throughout the test.
                <br />
